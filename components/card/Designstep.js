...
export default function Designstep({ number, text, bigText }) {
  return (
    <div className="h-48 md:h-40 lg:h-40 xl:h-44 p-10 w-80 md:w-80 lg:w-80 xl:w-96 flex flex-col ring-1 ring-gray-100 shadow-lg gap-1.5 bg-white" style={{ "borderBottomRightRadius": "5rem", "borderTopLeftRadius": "5rem" }}>
      ...
      <div className="mt-4 md:mt-1 xl:mt-2 px-8 text-center font-bold">{bigText}</div>
    </div>
  )
}

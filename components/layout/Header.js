      ...
      <div className="w-3/4 flex flex-row justify-center md:justify-between my-3">
        <Link href="/">
          <img
            ...
            alt=""
            className=" rounded-full w-10 cursor-pointer hidden md:inline"
          />
        </Link>
        <div className="space-x-3 text-xs flex flex-nowrap items-center font-extrabold tracking-tight">
          <ul
            className={
              ...
              (router.pathname == "/" ? "text-green-400" : "")
            }
          >
            <Link href="/">HOME</Link>
          </ul>
          ...
          <ul
            className={
              "hover:text-green-400 " +
              (router.pathname == "/contact" ? "text-green-400" : "")
            }
          >
          ...
          <ul
            className={
              "hover:text-green-400 " +
              (router.pathname == "/about" ? "text-green-400" : "")
            }
          >

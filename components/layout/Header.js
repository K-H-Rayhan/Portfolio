...
function header() {
    return (
        <div className="fixed top-0 flex justify-center font-semibold w-full shadow-md bg-white backdrop-filter backdrop-blur-md bg-opacity-75">
            <Head>
            ...
            <div className="w-3/4 flex flex-row justify-center sm:justify-between my-3">
                <Link href="/" >
                    <img src="/images/unnamed.jpg" alt="" className=" rounded-full w-10 cursor-pointer hidden sm:inline" />
                </Link>

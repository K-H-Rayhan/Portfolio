  ...
  return (
    <Layout>
      <div className="grid md:grid-cols-3 grid-cols-1 my-3.5 md:my-0 h-screen items-center justify-items-center w-full lg:w-3/5 md:w-3/4" >
        ...
        <div className="md:col-span-2 flex flex-col items-center text-center self-start md:self-center ">
          <div className="text-transparent bg-clip-text bg-gradient-to-br from-green-600 to-indigo-500 tracking-wider text-sm">GAMER, GRAPHICS DESIGNER, PROGRAMMER</div>
